    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="nav nav-tabs">
          ...
          <li class><a href="#tab-history" data-toggle="tab"><?php echo $tab_history; ?></a></li>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-history">
            ...
            <fieldset>
              <legend><?php echo $text_manager; ?></legend>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="order_status_id" id="input-order-status" class="form-control">
                      ...
                      <?php if ($order_statuses['order_status_id'] == 5) { ?>
              ...
              <div class="text-right">
                <button id="button-history" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_order_process; ?></button>
              </div>
            </fieldset>
			<?php endif; ?>
          </div>

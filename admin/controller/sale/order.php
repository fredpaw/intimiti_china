...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'manager'		=> $this->url->link('sale/order/manager', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'] . $url, 'SSL')
			);
		}
	...
	public function manager() {
		...
		if ($order_info) {
			...
			$data['button_commission_remove'] = $this->language->get('button_commission_remove');
			$data['button_history_add'] = $this->language->get('button_history_add');
			$data['button_order_process'] = $this->language->get('button_order_process');
			...
			$this->response->setOutput($this->load->view('sale/order_manager.tpl', $data));
		} else {
			$this->load->language('error/not_found');
